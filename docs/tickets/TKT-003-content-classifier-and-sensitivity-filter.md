...
- ARCH-001@0.1.1 §5 Data Model (`ClassifiedItem`, `SensitivityKeyword`, `Metrics` schemas — `classify.py` increments `items_classified`; `usage.py` persists `llm_calls_total`, `llm_tokens_total`, `llm_errors` to the `Metrics` table)
