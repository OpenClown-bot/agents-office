...
- Source CRUD commands in the bot — belongs to TKT-005@0.1.0
- Source ingestion — belongs to TKT-002@0.1.0
- PO candidate approval UI — belongs to TKT-005@0.1.0

## 4. Inputs (Executor MUST read before writing code)
- ARCH-001@0.1.0 §3.7 SourceDiscovery (responsibility, inputs, outputs, failure modes)
- ARCH-001@0.1.0 §5 Data Model (`SourceCandidate`, `RawItem` schemas)
- TKT-001@0.1.0 outputs: `db.py`, `models.py`, `config.py`
- TKT-002@0.1.0 outputs: `RawItem` rows populated by ingestion
