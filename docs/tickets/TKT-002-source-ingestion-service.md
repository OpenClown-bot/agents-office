...
- Source autodiscovery — belongs to TKT-008@0.1.0
- Source CRUD via bot commands — belongs to TKT-005@0.1.0
- APScheduler job registration — belongs to TKT-007@0.1.0

## 4. Inputs (Executor MUST read before writing code)
- ARCH-001@0.1.0 §3.1 SourceIngester (responsibility, inputs, outputs, failure modes)
- ARCH-001@0.1.0 §5 Data Model (`Source`, `RawItem` schemas)
- ARCH-001@0.1.0 §6 External Interfaces (RSS, Telegram Bot API source ingestion)
